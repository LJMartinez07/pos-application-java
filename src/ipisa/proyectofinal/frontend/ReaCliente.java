...
public class ReaCliente extends javax.swing.JDialog{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reactivar Cliente");
        jPanel2.add(jLabel1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "Update Clientes set Activo = 'Activo' where IdCliente = "+ f;
        try {
            PreparedStatement ps = cn.prepareStatement(sql);
            ps.executeUpdate();
            JOptionPane.showMessageDialog(this, "Cliente Reactivado");
        } catch (SQLException ex) {
            Logger.getLogger(ReaCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
