...
public class ReaSuplidor extends javax.swing.JDialog{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reactivar Suplidor");
        jPanel2.add(jLabel1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "Update Suplidores set Activo = 'Activo' where IdSupli = "+ f;
        try {
            PreparedStatement ps = cn.prepareStatement(sql);
            ps.executeUpdate();
            JOptionPane.showMessageDialog(this, "Cliente Reactivado");
        } catch (SQLException ex) {
            Logger.getLogger(ReaSuplidor.class.getName()).log(Level.SEVERE, null, ex);
        }
