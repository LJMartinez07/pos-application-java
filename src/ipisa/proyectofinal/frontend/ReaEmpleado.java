...
public class ReaEmpleado extends javax.swing.JDialog{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reactivar Empleado");
        jPanel2.add(jLabel1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "Update Empleados set Activo = 'Activo' where IdEmpleado = "+ f;
        try {
            PreparedStatement ps = cn.prepareStatement(sql);
            ps.executeUpdate();
            JOptionPane.showMessageDialog(this, "Empleado Reactivado");
        } catch (SQLException ex) {
            Logger.getLogger(ReaEmpleado.class.getName()).log(Level.SEVERE, null, ex);
        }
