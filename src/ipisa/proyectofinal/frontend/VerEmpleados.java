 ...
 */
public class VerEmpleados extends javax.swing.JDialog implements ISubject {
    TableModelsEmpleado tmem = new TableModelsEmpleado();
    /**
    ...
    public void Cargar(){
        if (this.txtBuscar.getText().isEmpty() && this.jTextField1.getText().isEmpty()) {
            tmem.NoveEmp(tblDe);
            
        }else{
            tmem.BNoveEmp(this.tblDe, this.jTextField1.getText(), this.jTextField2.getText());
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Novedades de los empleados");
        jPanel7.add(jLabel3);
