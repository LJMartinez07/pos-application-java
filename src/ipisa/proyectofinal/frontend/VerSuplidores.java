 ...
 */
public class VerSuplidores extends javax.swing.JDialog implements ISubject {
 TableModelsSuplidores tms  = new TableModelsSuplidores();
    /**
     * Creates new form AgreCliente
     */
    public VerSuplidores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tms.initTable2(jTable1);
    }
