...
public class ReaCategoria extends javax.swing.JDialog{
    private Conexion mysql = new Conexion();
    private Connection cn = mysql.conectar();

    
    TableModelsCategoria tmca = new TableModelsCategoria();
    public ReaCategoria(){
        initComponents();
        tmca.ReCategoria(reCa);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reactivar Categoria");
        jPanel2.add(jLabel1);

        jTextField1.setToolTipText("Ingrese el id del cliente");
        ...
        reCa.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "Update Categorias set Activo = 'Activo' where IdCategoria = "+ f;
        try {
            PreparedStatement ps = cn.prepareStatement(sql);
            ps.executeUpdate();
            JOptionPane.showMessageDialog(this, "Categoria Reactivado");
        } catch (SQLException ex) {
            Logger.getLogger(ReaCategoria.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private javax.swing.JTable reCa;
