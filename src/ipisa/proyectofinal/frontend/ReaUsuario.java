...
public class ReaUsuario extends javax.swing.JDialog{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reactivar Usuario");
        jPanel2.add(jLabel1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "Update Usuarios set Activo = 'Activo' where usuario = '"+f+"'";
        try {
            PreparedStatement ps = cn.prepareStatement(sql);
            ps.executeUpdate();
            JOptionPane.showMessageDialog(this, "Cliente Reactivado");
        } catch (SQLException ex) {
            Logger.getLogger(ReaUsuario.class.getName()).log(Level.SEVERE, null, ex);
        }
